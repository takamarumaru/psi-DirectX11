...
ID3D11SamplerState* Direct3D::CreateSamplerState(KdSamplerFilterMode filterType, UINT maxAnisotropy, KdSamplerAddressingMode addressingMode, bool comparisonModel) const
{
...
ID3D11BlendState* Direct3D::CreateBlendState(KdBlendMode mode) const
{
